...
public class EmployeePayrollServiceTest {
	...
	/**
	 * test case is created to check whether data is retrieved from database in a
	...
	public void givenPayrollData_WhenAverageSalaryRetrieveByGender_ShouldReturnValue() {
		...
		Assert.assertTrue(
				averageSalaryByGender.get("M").equals(500000.00) && averageSalaryByGender.get("F").equals(475000.00));
	}
	...
	public void givenPayrollData_WhenSumSalaryRetrieveByGender_ShouldReturnValue() {
		...
		Assert.assertTrue(
				sumSalaryByGender.get("M").equals(1500000.00) && sumSalaryByGender.get("F").equals(950000.00));
	}
	...
	public void givenPayrollData_WhenMinimumSalaryRetrieveByGender_ShouldReturnValue() {
		...
		Assert.assertTrue(
				minimumSalaryByGender.get("M").equals(400000.00) && minimumSalaryByGender.get("F").equals(450000.00));
	}
	...
	public void givenPayrollData_WhenMaximumSalaryRetrieveByGender_ShouldReturnValue() {
		...
		Assert.assertTrue(
				maximumSalaryByGender.get("M").equals(600000.00) && maximumSalaryByGender.get("F").equals(500000.00));
	}
	...
	public void givenPayrollData_WhenCountNameRetrieveByGender_ShouldReturnValue() {
		...
		Assert.assertTrue(countNameByGender.get("M").equals(3) && countNameByGender.get("F").equals(2));
	}
}